        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            <div className="inline-flex items-center gap-2 mb-6">
              ...
              <span className="text-gold text-sm tracking-widest font-light">EDUCATION PLATFORM</span>
            </div>
            ...
            <Button 
              ...
              className="bg-gold text-black hover:bg-gold/90 px-8 py-3 text-lg font-medium"
            >
              START LEARNING
            </Button>
          </div>
