  ...
  const teamMembers = [
    {
      ...
      highlights: [
        "Develops and implements strategic plans that drive business growth",
        "Leads the company with a vision of excellence and innovation",
        "Builds and maintains a vast network of industry professionals",
        "Oversees real estate projects from start to finish with flawless execution",
        "Ensures every deal meets Kings 'n Company's high standards"
      ]
    },
    {
      id: 2,
      ...
      highlights: [
        "Specialist in identifying high-return investment opportunities",
        "Deep understanding of real estate finance and profitability",
        "Passionate about building strong, trust-based client relationships",
        "Committed to achieving ambitious investment goals for clients"
      ]
    }
  ];
              ...
              <CardContent className="p-0">
                ...
                <div className="p-8">
                  ...
                  <div className="flex gap-3">
                    <Button 
                      size="sm"
                      className="bg-gold hover:bg-gold-light text-black font-medium tracking-wider flex-1 transition-all duration-300"
                    >
                      Let's Talk
                    </Button>
                    <Button 
                      size="sm"
                      variant="outline"
                      className="border-gray-600 text-gray-300 hover:bg-gray-800 hover:text-white flex-1 transition-all duration-300"
                    >
