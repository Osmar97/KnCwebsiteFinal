  ...
  return <section className="py-20 bg-gradient-to-r from-gray-900 to-black">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-3 gap-8 mb-16">
          {strategies.map((strategy, index) => <div key={index} className="bg-gray-900 p-8 rounded-lg shadow-xl text-center group hover:shadow-2xl hover:shadow-gold/20 transition-all duration-300 border border-gray-800">
