  ...
  const teamMembers = [
    {
      ...
      quote:
        "My mission is to create valuable connections and long-term wealth for our clients, guiding them through one of the most impactful decisions of their lives.",
      linkedin: "https://pt.linkedin.com/in/ismaelgq",
      instagram:
        "https://www.instagram.com/ismaelgq_/profilecard/?igsh=ZWloM3JwdTE4aWgz",
      flagEmoji: "🇬🇼", // Guinea-Bissau
    },
    {
      id: 2,
      name: "Nuno Andrade",
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0">
        ...
        <div
          className="absolute bottom-1/4 right-0 w-96 h-96 bg-gold/5 rounded-full blur-3xl animate-pulse"
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          <div className="inline-flex items-center gap-2 mb-6">
            ...
            <span className="text-gold text-sm tracking-widest font-light">
              MEET THE EXPERTS
            </span>
            <Users className="w-6 h-6 text-gold animate-pulse" />
          </div>
          ...
          <p className="text-gray-300 text-xl max-w-4xl mx-auto font-light leading-relaxed">
            Meet the dedicated professionals who make property ownership dreams
            come true
          </p>
        </div>
        ...
        {/* Team Grid */}
        <div
          className={`grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 mb-16 transition-all duration-1000 ${
            isVisible
              ? "opacity-100 translate-y-0"
              : "opacity-0 translate-y-8"
          }`}
        >
          {teamMembers.map((member, index) => (
            <Card
              key={member.id}
              className={`bg-gradient-to-br from-gray-900/80 to-black/80 border-gray-700/50 backdrop-blur-sm overflow-hidden group hover:border-gray-600/50 transition-all duration-500 transform hover:scale-105 ${
                isVisible
                  ? "opacity-100 translate-y-0"
                  : "opacity-0 translate-y-8"
              }`}
            ...
            >
              <CardContent className="p-0">
                  ...
                  <div className="absolute top-4 right-4 opacity-0 group-hover:opacity-100 transition-all duration-300 transform translate-y-2 group-hover:translate-y-0 flex gap-2">
                    {member.linkedin && (
                      <a
                        ...
                        className="w-12 h-12 bg-gold/90 backdrop-blur-sm rounded-full flex items-center justify-center hover:bg-gold transition-colors"
                      >
                ...
                <div className="p-8">
                  ...
                  <p className="text-gold text-lg mb-2 font-light">
                    {member.role}
                  </p>
